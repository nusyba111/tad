...
class SrcsPurchase(models.Model):
    ...
    purchase_request_id = fields.Many2one(comodel_name="purchase.request", string="Purchase Request",readonly=True )
    ...
    def _check_total(self):
        ...
        for record in self:
            ...
            if record.currency_id == record.budget_line_id.currency_budget_line.id:
                ...
                if record.budget_line_id.currency_budget_line.rate != 0:
